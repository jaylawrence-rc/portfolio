...
export function Footer() {
  return (
    <footer className="editorial-footer shell">
      ...
      <div className="editorial-footer-bottom"><span>© {new Date().getFullYear()} Jay Lawrence Dimaano</span><nav aria-label="Footer navigation"><Link href="/work">Work</Link><Link href="/about">About</Link><Link href="/blog">Journal</Link><a href={labUrl}>Lab <ArrowUpRight size={13} aria-hidden="true" /></a><Link href="/resume">Résumé <ArrowUpRight size={13} aria-hidden="true" /></Link><Link href="/contact">Contact</Link><a href={profile.linkedin} target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={13} aria-hidden="true" /></a><a href={profile.github} target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={13} aria-hidden="true" /></a></nav><span>Philippines · GMT+8</span></div>
    </footer>
  );
}
