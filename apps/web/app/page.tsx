...
export default function Home() {
  return <>
    <section className="hero shell">
      ...
      <dl className="proof-strip"><div><dt>Current focus</dt><dd>AI healthcare workflows at RAVPRO</dd></div><div><dt>Based in</dt><dd>Cainta, Philippines · GMT+8</dd></div><div><dt>Working across</dt><dd>Product · frontend · systems</dd></div></dl>
    </section>
