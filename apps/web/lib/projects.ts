...
export type Project = {
  ...
  hoverPage?: { url: string; label: string };
  liveUrl?: string;
...
export const projects: Project[] = [
  {
    ...
    hoverPage: { url: "https://musicstats.com/playlist-analyzer", label: "Playlist Analyzer" },
    ...
    disciplines: ["Product engineering", "Data products", "Design systems"], industry: "Music intelligence", accent: "#f3bb42", liveUrl: "https://musicstats.com/", allowsEmbedding: true,
